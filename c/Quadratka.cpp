...
int KolichestvoKorney (double a, double b, double c, double* x1, double* x2);// сделать норм имя
void KakayaToFunc(int Peremennaya, double x1, double x2);// сделать норм имя
int check(double s);
